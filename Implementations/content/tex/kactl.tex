...
\team{gthr}{Ignacio Castellano}
\contest{Ada Byron Nacional 2024}{July 6, 2024}
\contest{adapted from KACTL and MIT \$(\^{}w\^{})\$}{\today}
\enablecolors
...
% test compile all in section
	% find 'content/geometry' -name '*.h' -exec sh test-compiles.sh "{}" \;
